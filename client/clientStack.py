...
class LC_ClientStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        getUserDataLmbd = aws_lambda.Function(self, "getUserData",
                                              runtime=aws_lambda.Runtime.PYTHON_3_11,
                                              code=aws_lambda.Code.from_asset(
                                                  path.join(basePath, "user/data")),
        ...
        createUserLmbd = aws_lambda.Function(self, "createUser",
                                             runtime=aws_lambda.Runtime.PYTHON_3_11,
                                             code=aws_lambda.Code.from_asset(
                                                 path.join(basePath, "user/create")),
                                             handler="main.handler",
                                             function_name="lc-client-createUser"
                                             )
        api = aws_apigateway.RestApi(self, "client-api",
